...
class CoTenantDetails extends StatefulWidget {
  const CoTenantDetails({Key? key}) : super(key: key);

  @override
  State<CoTenantDetails> createState() => _CoTenantDetailsState();
}

class _CoTenantDetailsState extends State<CoTenantDetails> {
  @override
