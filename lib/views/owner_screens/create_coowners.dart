...
class CoOwnerProfile extends StatefulWidget {
  const CoOwnerProfile({Key? key}) : super(key: key);

  @override
  State<CoOwnerProfile> createState() => _CoOwnerProfileState();
}

class _CoOwnerProfileState extends State<CoOwnerProfile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            _buildHeader("Create Co Owner", "Upload CSV"),
            ...
            child: Column(
              children: [
                ...
                Text(
                  ...
                  "Co Owner account created successfully ",
                  style:
